...
export function overlayFriend(opts?: OverlayOptions): string {
  ...
  return wrapOverlay(
    `<rect x="4" y="4" width="28" height="28" rx="2" stroke="${color}" stroke-width="1.8" fill="${color}" fill-opacity="0.08"/>`,
    opts
  );
}
...
export function overlayHostile(opts?: OverlayOptions): string {
  ...
  return wrapOverlay(
    `<polygon points="18,3 33,18 18,33 3,18" stroke="${color}" stroke-width="1.8" fill="${color}" fill-opacity="0.08"/>`,
    opts
  );
}
...
export function overlayNeutral(opts?: OverlayOptions): string {
  ...
  return wrapOverlay(
    `<rect x="5" y="5" width="26" height="26" stroke="${color}" stroke-width="1.8" fill="${color}" fill-opacity="0.08"/>`,
    opts
  );
}
...
export function overlayUnknown(opts?: OverlayOptions): string {
  ...
  return wrapOverlay(
    `<path d="M18 3 C27 3 33 9 33 18 C33 27 27 33 18 33 C9 33 3 27 3 18 C3 9 9 3 18 3 Z" stroke="${color}" stroke-width="1.8" stroke-dasharray="3 2" fill="${color}" fill-opacity="0.08"/>`,
    opts
  );
}
