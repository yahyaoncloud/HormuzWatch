...
export default function LoginRoute() {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center bg-[#060810] text-slate-100 px-4 sm:px-6 overflow-hidden selection:bg-indigo-600 selection:text-white font-ui">
      ...
      {/* Refined Login Form Container */}
      <div className="relative z-10 w-full max-w-[420px] rounded-2xl border border-indigo-500/25 bg-[#0b111e]/90 shadow-[0_0_60px_-15px_rgba(99,102,241,0.25)] backdrop-blur-2xl p-7 sm:p-9 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="space-y-1.5">
            <label className="flex items-center justify-between font-ui text-xs font-medium text-slate-300">
              ...
              <span className="font-mono text-[10px] text-slate-500">256-bit AES</span>
            </label>
            <div className="relative flex items-center">
        ...
        <div className="mt-6 pt-5 border-t border-slate-800/80 text-center text-xs text-slate-400">
          <span>Need administrator credentials? </span>
          <Link
            to="/register"
