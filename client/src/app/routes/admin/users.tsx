        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-[var(--color-border)] bg-[var(--color-bg-elevated)]">
              <th className="px-4 py-3 text-left font-ui text-[11px] text-[var(--color-fg-muted)] uppercase tracking-wider">
                Username
              </th>
              <th className="px-4 py-3 text-left font-ui text-[11px] text-[var(--color-fg-muted)] uppercase tracking-wider">
                Email
          ...
          <tbody>
            {users.map((u: SiteUser) => (
              ...
              >
                <td className="px-4 py-3 font-semibold text-sm text-[var(--color-fg)]">
                  {u.username}
                </td>
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-1">
                    <button
                      type="button"
                      className="p-1 rounded hover:bg-[var(--color-success)]/10 text-[var(--color-success)]"
                      title="Approve"
                    >
