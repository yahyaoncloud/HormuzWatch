...
export default function PublicLandingPage() {
  ...
  return (
    <div style={{ position: "relative", width: "100vw", height: "100vh", overflow: "hidden", background: "#020617" }}>
      ...
      {/* ─── LEFT STATS STRIP (Matched to Dashboard Cards) ─── */}
      <div style={{
      ...
      <div style={{
        position: "absolute", bottom: "30px", left: "20px", zIndex: 1001,
        width: "340px",
        background: "rgba(11,18,32,0.8)", backdropFilter: "blur(16px)",
        border: "1px solid rgba(148,163,184,0.1)", borderRadius: "10px",
        padding: "24px",
        ...
        <h2 style={{
          color: "#f8fafc", fontSize: "1.125rem", fontWeight: 800, margin: "0 0 10px 0",
          lineHeight: 1.3,
        }}>
          Strait of Hormuz<br />
      ...
      {/* ─── BOTTOM-RIGHT LIVE THREAT TICKER ─── */}
      {criticals.length > 0 && (
        <div style={{
